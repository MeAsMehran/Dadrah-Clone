...
class Lawyer(models.Model):
    ...
    gender = models.CharField(max_length=6, choices=[('female', 'Female'), ('male', 'Male')], default='male', blank=False)
    phone = models.CharField(max_length=10, unique=True, help_text="09xx xxx xxxx", blank=False, null=False, error_messages={'unique': 'The phone number is already in use.'}, )
